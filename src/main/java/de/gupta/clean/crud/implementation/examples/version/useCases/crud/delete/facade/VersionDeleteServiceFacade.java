package de.gupta.clean.crud.implementation.examples.version.useCases.crud.delete.facade;
...
@Component
@Qualifier("versionDeleteServiceFacade")
final class VersionDeleteServiceFacade extends
		AbstractDeleteServiceFacade<Long, Long>
		implements DeleteServiceFacade<Long>
{
	VersionDeleteServiceFacade(
			@Qualifier("versionDeleteService") final DeleteService<Long> service,
