...
final class RegisterTaskCreationHandler
		implements AggregateCreationHandler<TaskDomainModelCreate, RegisterTaskCreation>
{
	@Override
	public AggregateCreationPlan<TaskDomainModelCreate> apply(final RegisterTaskCreation payload)
	{
		return AggregateCreationPlan.rootOnly(TaskDomainModelCreate.of(
				payload.title(),
				payload.description(),
