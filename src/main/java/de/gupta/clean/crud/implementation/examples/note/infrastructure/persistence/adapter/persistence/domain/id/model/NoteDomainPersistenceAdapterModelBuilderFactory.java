...
@Component
@Qualifier("noteDomainPersistenceAdapterModelBuilderFactory")
final class NoteDomainPersistenceAdapterModelBuilderFactory
		implements
		ModelBuilderFactory<DomainPersistenceAdapterModel<Long, UUID>, DomainPersistenceAdapterModel.Builder<Long,
				UUID, NoteDomainPersistenceAdapterModel>>
{
	@Override
	public DomainPersistenceAdapterModel.Builder<Long, UUID, NoteDomainPersistenceAdapterModel> builder()
	{
		return NoteDomainPersistenceAdapterModel.builder();
	}
}