package de.gupta.clean.crud.implementation.examples.task.useCases.mutation.annotate.configuration;
...
import de.gupta.clean.crud.template.useCases.mutation.domain.handler.AggregateMutationHandler;
