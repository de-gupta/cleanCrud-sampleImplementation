package de.gupta.clean.crud.implementation.examples.note.useCases.crud.delete.facade;
...
@Component
@Qualifier("noteDeleteServiceFacade")
final class NoteDeleteServiceFacade extends
		AbstractDeleteServiceFacade<Long, Long>
		implements DeleteServiceFacade<Long>
{
	NoteDeleteServiceFacade(
			@Qualifier("noteDeleteService") final DeleteService<Long> service,
